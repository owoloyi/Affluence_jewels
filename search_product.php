        ...
        <div class="container-fluid p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./users_area/Profile.php">Acoount</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="row px-1">
        <div class="col-md-10">
            ...
            <div class="row">
                ...
                // Only show search results if search is submitted
        ...
        <footer class="bg-dark text-white text-center p-4 mt-5">
            <div class="container">
                ...
                <form class="d-flex flex-column flex-sm-row gap-2 justify-content-center mb-4" method="post"
                    action="subscribe.php">
                    <input type="email" name="email" class="form-control w-auto" placeholder="Enter your email"
                        required>
                    <button type="submit" class="btn btn-primary">Subscribe</button>
                </form>

                <div class="social-icons mb-3">
                    <!-- WhatsApp link (updated number + message) -->
                    <a href="https://wa.me/2347018391251?text=Hi%20Jewelry%20Shop%2C%20I'm%20interested%20in%20your%20products."
                        class="text-white me-3 hover-effect" target="_blank" rel="noopener">
                        <i class="fab fa-whatsapp fa-lg"></i>
                    </a>

                    <!-- Instagram link (corrected) -->
                    <a href="https://instagram.com/grandsabor_restaurantabuja" class="text-white me-3 hover-effect"
                        target="_blank" rel="noopener">
                        <i class="bi bi-instagram" style="font-size: 1.5rem;"></i>
                    </a>

                    <!-- Facebook placeholder -->
                    <a href="https://www.facebook.com/yourjewelrystore" class="text-white me-3 hover-effect"
                        target="_blank" rel="noopener">
